  ...
  HomeAdapter()
      : super(
          slots:<Dependent<HomeState>>[
            HomeHeadComponent().asDependent(_HomeHeadConnector()),
            HomeItemAdapter().asDependent(_HomeItemConnector()),
          ],
          );
}
