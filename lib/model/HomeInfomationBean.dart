...
part 'HomeInfomationBean.g.dart';


@JsonSerializable()
class HomeInfomationBean extends Object {
  ...
  HomeInfomationBean(this.curPage,this.datas,this.offset,this.over,this.pageCount,this.size,this.total,);

  factory HomeInfomationBean.fromJson(Map<String, dynamic> srcJson) => _$HomeInfomationBeanFromJson(srcJson);

  Map<String, dynamic> toJson() => _$HomeInfomationBeanToJson(this);
